...
myprint('decreasing_lr: ' + str(decreasing_lr))
...
try:
    ...
    for epoch in range(args.epochs):
        ...
        myprint("Elapsed {:.2f}s, {:.2f} s/epoch, {:.2f} s/batch, ets {:.2f}s".format(
        ...
        if epoch % args.test_interval == 0:
            ...
            myprint('\tTest set: Average loss: {:.4f}, Accuracy: {}/{} ({:.0f}%)'.format(
    ...
    myprint("Total Elapse: {:.2f}, Best Result: {:.3f}%".format(time.time()-t_begin, best_acc))
